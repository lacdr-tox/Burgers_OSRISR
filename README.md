...
\- _FittingResults_ contains the results of the parameter optimisation process.

\- _Scripts_ contains all code to replicate data analysis steps, simulate the models and make the images. 
